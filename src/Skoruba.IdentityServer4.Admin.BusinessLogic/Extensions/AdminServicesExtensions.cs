...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class AdminServicesExtensions
    {
            ...
            where TLogDbContext : DbContext, IAdminLogDbContext
        {
            ...
            services.AddTransient<ILabsoftAccountExternalProviderRepository, LabsoftAccountExternalProviderRepository<TLogDbContext>>();
            ...
            services.AddTransient<ILabsoftAccountExternalProviderService, LabsoftAccountExternalProviderService>();
