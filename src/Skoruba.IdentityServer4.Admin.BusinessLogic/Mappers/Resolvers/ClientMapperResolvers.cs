...
{
    public class ClientPostLogoutRedirectUrisResolver : IValueResolver<Client, ClientDto, List<string>>
    {
    ...
    public class ClientRedirectUrisResolver : IValueResolver<Client, ClientDto, List<string>>
    {
        public List<string> Resolve(Client source, ClientDto destination, List<string> destMember, ResolutionContext context)
        {
    ...
    public class ClientScopesResolver : IValueResolver<Client, ClientDto, List<string>>
    {
        public List<string> Resolve(Client source, ClientDto destination, List<string> destMember, ResolutionContext context)
        {
    ...
    public class ClientGrantTypesResolver : IValueResolver<Client, ClientDto, List<string>>
    {
        public List<string> Resolve(Client source, ClientDto destination, List<string> destMember, ResolutionContext context)
        {
    ...
    public class ClientDtoPostLogoutRedirectUrisResolver : IValueResolver<ClientDto, Client, List<ClientPostLogoutRedirectUri>>
    {
    ...
    public class ClientDtoRedirectUrisResolver : IValueResolver<ClientDto, Client, List<ClientRedirectUri>>
    {
    ...
    public class ClientDtoScopesResolver : IValueResolver<ClientDto, Client, List<ClientScope>>
    {
    ...
    public class ClientDtoGrantTypesResolver : IValueResolver<ClientDto, Client, List<ClientGrantType>>
    {
