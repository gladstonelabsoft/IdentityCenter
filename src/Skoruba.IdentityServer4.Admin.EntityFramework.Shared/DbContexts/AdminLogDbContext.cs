...
namespace Skoruba.IdentityServer4.Admin.EntityFramework.Shared.DbContexts
{
    public class AdminLogDbContext : DbContext, IAdminLogDbContext
    {
        ...
        public DbSet<LabsoftAccountExternalProvider> LabsoftAccountExternalProviders { get; set; }
        ...
        private void ConfigureLogContext(ModelBuilder builder)
        {
            ...
            builder.Entity<LabsoftAccountExternalProvider>().ToTable(TableConsts.LabsoftAccountExternalProvider);
        }
    }
}
