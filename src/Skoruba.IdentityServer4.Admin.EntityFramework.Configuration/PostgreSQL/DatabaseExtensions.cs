...
namespace Skoruba.IdentityServer4.Admin.EntityFramework.Configuration.PostgreSQL
{
    public static class DatabaseExtensions
    {
        ...
        public static void RegisterNpgSqlDbContexts<TIdentityDbContext, TConfigurationDbContext,
            TPersistedGrantDbContext, TDataProtectionDbContext, TAdminLogDbContext>(this IServiceCollection services,
            ...
            where TAdminLogDbContext : DbContext, IAdminLogDbContext
        {
            ...
            services.AddDbContext<TAdminLogDbContext>(options => options.UseNpgsql(dataProtectionConnectionString, sql => sql.MigrationsAssembly(migrationsAssembly)));
        }
    }
}