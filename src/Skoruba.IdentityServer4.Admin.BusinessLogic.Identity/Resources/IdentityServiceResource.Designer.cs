...
namespace Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Resources {
    ...
    public class IdentityServiceResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to User Reset Password failed.
        /// </summary>
        public static string UserResetPasswordFailed
        {
            get
            {
                return ResourceManager.GetString("UserResetPasswordFailed", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to User with email {0} doesn&apos;t exist.
        /// </summary>
        public static string UserEmailDoesNotExist
        {
            get
            {
                return ResourceManager.GetString("UserEmailDoesNotExist", resourceCulture);
            }
        }
