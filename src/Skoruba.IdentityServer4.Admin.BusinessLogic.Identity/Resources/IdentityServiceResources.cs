...
namespace Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Resources
{
    public class IdentityServiceResources : IIdentityServiceResources
    {
        ...
        public virtual ResourceMessage UserResetPasswordFailed()
        {
            return new ResourceMessage()
            {
                Code = nameof(UserResetPasswordFailed),
                Description = IdentityServiceResource.UserResetPasswordFailed
            };
        }
        ...
        public virtual ResourceMessage UserEmailDoesNotExist()
        {
            return new ResourceMessage()
            {
                Code = nameof(UserEmailDoesNotExist),
                Description = IdentityServiceResource.UserEmailDoesNotExist
            };
        }
