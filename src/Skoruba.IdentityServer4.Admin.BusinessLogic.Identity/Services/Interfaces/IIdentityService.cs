...
namespace Skoruba.IdentityServer4.Admin.BusinessLogic.Identity.Services.Interfaces
{
        ...
        where TRoleClaimDto : RoleClaimDto<TKey>
    {
        ...
        Task<string> UserResetTokenByEmailAsync(string email);

        Task<IdentityResult> UserResetPasswordByEmailAsync(string email, string password, string code);

        Task<IdentityResult> UserChangePasswordByEmailAsync(string email, string currentPassword, string newPassword);
